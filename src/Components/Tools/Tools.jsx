...
const Tools = () => {
  ...
  return (
    <div className="py-16 bg-gradient-to-l from-[#1d2e56] to-[#0B1120] px-2 md:px-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 place-content-center w-full ">
        <div
          data-aos="fade-right"
          className="bg-[#1d2947] text-[#38BDF8] p-4 rounded-lg m-4 shadow-lg hover:transform hover:-translate-y-2 transition-all duration-300 "
        >
          <div className="flex gap-2">
            <span>
              <BiLogoFirebase color="#ffff" size={48} />
            </span>
            <div>
        ...
        <div
          data-aos="fade-left"
          className="bg-[#1d2947] text-white p-4 rounded-lg m-4 shadow-lg hover:transform hover:-translate-y-2 transition-all duration-300"
        >
          <div className="flex gap-2">
            <span>
              <IoLogoVercel color="#ffff" size={48} />
            </span>
            <div>
              <h1 className="text-2xl font-bold text-[#38BDF8]">Vercel</h1>
              <p className="text-gray-300">
        ...
        >
          <div className="flex gap-2">
            <span>
              <BiGitCommit color="#ffff" size={48} />
            </span>
            <div>
              <h1 className="text-2xl font-bold text-[#38BDF8]">Git&GitHub</h1>
              <p className="text-gray-300">
        ...
        >
          <div className="flex gap-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#38BDF8]">Visual Studio Code</h1>
              <p className="text-gray-300">
